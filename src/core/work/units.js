...
const pipelines = [
  ...
  },
  {
    ...
    defaultTaskTemplateIds: [
      'media_article_short_interview',
      'media_article_short_write',
      'media_article_short_photo_select',
      'media_article_short_photo_edit',
      'media_article_short_readability',
      'media_article_short_social',
      'media_article_short_publish',
      'media_article_short_archive'
    ],
    defaultTemplateIds: [
      'media_article_short_interview',
      'media_article_short_write',
